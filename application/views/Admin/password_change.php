...
<div class="container">
  <div class="col-md-6 col-md-offset-3">
    <?php if($error = $this->session->flashdata('msg')){ ?>
      <p style="color: #a94442;"><strong><b>Error!</b></strong> <?php echo  $error; ?><p>
  <?php  }  ?>
  <?php if($error = $this->session->flashdata('msg1')){ ?>
    <p style="color: green;"><strong>Congratulation</strong> <?php echo  $error; ?><p>
<?php  }  ?>
          ...
          <form method="post" action="<?php echo base_url(); ?>admin/home/change_password">
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <span class="text-danger"><p style="color: #a94442" <?php echo form_error('old_pass'); ?> </span>
               </div>
               <div class="form-group">
                    <label>New Password </label>
                    <input type="password" name="new_pass" class="form-control"  />
                    <span class="text-danger"><p style="color: #a94442" <?php echo form_error('new_pass'); ?> </span>
               </div>
               <div class="form-group">
                    <label>Confirm Password </label>
                    <input type="password" name="c_pass" class="form-control"  />
                    <span class="text-danger"><p style="color: #a94442" <?php echo form_error('c_pass'); ?> </span>
               </div>
