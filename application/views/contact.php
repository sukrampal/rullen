...
s1.async=true;
s1.src='https://embed.tawk.to/5da6f07411f2900bf447681b/default';
s1.charset='UTF-8';
             ...
             <?php } ?>
                    ...
                    <span class="text-danger"> <p style="color:red"<?php echo form_error('email'); ?> </span>
									...
									<div class="form-group contuct_f">
										...
										<input type="number" name="phone" value="<?php echo set_value('phone'); ?>" class="form-control"  placeholder="Phone Number" autocomplete="off"></input>
